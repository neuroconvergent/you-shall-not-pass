...
<required_reading>
@/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/get-shit-done/references/domain-probes.md
@/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/get-shit-done/references/gate-prompts.md
@/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/get-shit-done/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/get-shit-done/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
