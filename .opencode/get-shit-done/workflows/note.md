...
- **Global scope**: `/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/notes/`)
...
2. Glob `/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/notes/` — works in any directory
