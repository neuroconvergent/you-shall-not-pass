...
```bash
INIT=$(node "/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/get-shit-done/templates/spec.md.
