...
```
Task(
  prompt="Read /home/neuroconvergent/Programming/you-shall-not-pass/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/neuroconvergent/Programming/you-shall-not-pass/.opencode/get-shit-done/templates/VALIDATION.md`
